...
| `odni-icd-203-2025` | Office of the Director of National Intelligence, *ICD 203: Analytic Standards* | Quality anchors for describing sources and methodologies, explaining uncertainty, and distinguishing information, assumptions, and judgments | [Official PDF](https://www.odni.gov/files/documents/ICD/ICD-203.pdf), accessed 2026-08-19. Used as an anchor only; the project does not claim ICD 203 conformance. |
...
- All initial methods and profiles are `preview`. Passing schema validation does not establish
